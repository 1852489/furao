...
public interface PlayerMapper {
    ...
    @Insert("insert into player_arch values(player_id=#{player_id},arch_id=#{arch_id},order=#{order})")
    ...
    @Insert("insert into player_card values(player_id=#{player_id},card_id=#{card_id},order=#{order})")
